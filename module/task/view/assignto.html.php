    ...
    <form method='post' target='hiddenwin'>
      <table class='table table-form'>
        <tr>
          ...
          <td width="160">
             <!-- 选择园区 -->
             <div id="selectProject" class="inline">
                 <select onchange="loadProjectMembers($(this).val());">
          ...
          <td class='w-p75-f'>
            <span id="assignedToIdBox">
                <?php echo html::select('assignedTo', $members, empty($task->team) ? $task->assignedTo : $task->nextUser, "class='form-control chosen'");?>
            </span>
            </td><td></td>
        </tr>  
